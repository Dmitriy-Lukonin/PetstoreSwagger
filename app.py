...
# petId = 9223372036854606000
# pet_photo = 'C:\Skillfactory\Unit.19\Petstore_Swagger\PetSwagger\images\image.jpeg'
#
#
# def add_pet_photo():
...
# 12 POST /user/createWithArray Creates list of users with given input array (в чем прикол?)
...
# 13 POST /user/createWithList Creates list of users with given input array (в чем прикол?)
